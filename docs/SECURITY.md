...
Our primary goal is to ensure the protection and confidentiality of sensitive data stored by users on foss-webui.
...
For immediate concerns or detailed reports that meet our guidelines, please create an issue in our [issue tracker](/foss-webui/foss-webui/issues) or contact us on [Discord](https://discord.gg/5rJgQTnV4s).
